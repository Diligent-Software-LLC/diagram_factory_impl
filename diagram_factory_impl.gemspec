require_relative './lib/diagram_factory_impl/version'

Gem::Specification.new do |spec|

  # Required attributes.
  spec.name                  = "diagram_factory_impl"
  spec.version               = DiagramFactory::VERSION
  spec.authors               = ["Diligent Software LLC"]
  spec.email                 = ["contact@diligentsoftware.org"]
  spec.summary               = %q{A DiagramFactory library implementation.}
  spec.description           = %q{A DiagramFactory library implementation.
...
donations are available at $1, $2, $4, $8, and $16. Greatly appreciated.}
  spec.homepage              =
      "https://docs.diligentsoftware.org/diagram-1/factory/implementation"
  ...
  spec.metadata['source_code_uri'] =
      "https://github.com/Diligent-Software-LLC/diagram_factory_impl"
